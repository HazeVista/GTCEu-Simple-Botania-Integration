...
public class GTBHelpers {
    ...
    public static Material getMaterial(@NotNull String materialName) {
        ...
        if (material == null) {
            material = GTCEuAPI.materialManager.getMaterial(GTBotania.MOD_ID + ":" + materialName);
        }
    ...
    public static void registerMaterialInfo(ResourceLocation itemId, Map<String, Double> materialStacks) {
        ...
        if (item == null) {
            GTBotania.LOGGER.error("Error in registerMaterialInfo - item not found: {}", itemId);
            return;
        }
        ...
        for (var tuple : materialStacks.entrySet()) {
            ...
            if (material == null) {
                GTBotania.LOGGER.error("Error in registerMaterialInfo - material not found: {}", tuple.getKey());
                return;
            }
